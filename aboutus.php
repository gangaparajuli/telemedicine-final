    ...
    <section id="about" class="about">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <div class="content">
                    <h3> About-us</h3>
                    <p>TeleCare is an easily accessible telemedicine platform that aims to improve the delivery of healthcare services. Our goal is to improve the healthcare experience by providing tools for symptom-based diagnosis, individualized treatment recommendations, and direct communication with medical specialists. We try to connect people with high-quality medical care, ensuring that help is always available, regardless of place or time.</p>
